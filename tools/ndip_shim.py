...
def merge_in(stage, state, manifest, exit_code=0, output_prefix=None):
    ...
    # Record the tool's self-reported version, keyed by call-stage so the two
    # calls sharing a target record do not clobber each other.
